...
johnnyswim = Concert.create!(artist: 'Oh Wonder', venue: 'House of Blues', city: 'Orlando', date: Time.new(2016,11,4,8), price: 25, description: 'Chill vibes and good times with these two')