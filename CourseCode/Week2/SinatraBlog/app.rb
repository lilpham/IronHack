...
# lillys_blog.add_post(post3) Post.new("Post 3", "16/7/30", "You're still reading mah blog!")
# lillys_blog.add_post(post4) Post.new("Post 4", "16/8/1", "YAY!!!")
# lillys_blog.add_post(post5) Post.new("Post 5", "16/8/3", "Today is great")
# lillys_blog.add_post(post6) Post.new("Post 6", "16/8/5", "Who are you?")
